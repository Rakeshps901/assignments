...
class _Farmers_freshuiState extends State<Farmers_freshui> {
  ...
  List itempic=['assets/fruits/apple.jpg','assets/fruits/banana.jpg','assets/fruits/grapes.jpg','assets/fruits/kiwi.jpg',
    'assets/fruits/mango.jpg','assets/fruits/orange.jpg'];
  @override
      ...
      body: Column(
        children: [
          ...
          CarouselSlider(items: [
            Image.asset('assets/fruits/freshfruits.jpg'),
            Image.asset('assets/fruits/freshveg.jpg')
          ],
